...
/**
 * 
 * Binary search is a fast search com.skryl.algorithm that works on sorted lists.
 ...
 * <p>
 * The com.skryl.algorithm looks for a match by comparing the middle item of a com.skryl.collection.
 ...
 * <p>
 * Basically, the list is divided into two halves and the search continues in the half where the element has a possibility of being located. This is why the com.skryl.algorithm requires a sorted list.
 * <p>
...
public class LinearBinarySearch {
	 ...
	 * We can use recursion to implement the com.skryl.algorithm. During each iteration, we take the middle element, compare it with the searched value, then take the corresponding half and repeat the process.
