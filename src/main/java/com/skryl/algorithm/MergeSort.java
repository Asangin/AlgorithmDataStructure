 ...
 * The idea of the merge sort com.skryl.algorithm is to divide the array in half over and over again until each piece is only one item long. Then those items are put back together (merged) in sort-order.
 * <p>
 ...
 * [1, 2, 4, 4, 31, 42, 88]
 * <p>
 * Now the array is sorted! The idea behind the com.skryl.algorithm is that smaller parts are easier to sort.
 * The merge operation is the most important part of the com.skryl.algorithm.
 * <p>
 ...
 * For arrays, the com.skryl.algorithm needs extra temporary storage space for each half during each iteration.
 * <p>
 ...
 * Let's implement the com.skryl.algorithm using recursion:
 *
